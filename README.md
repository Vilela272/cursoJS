<h1 align="center">
    <img src="https://i.ibb.co/0C1GYQ9/javascript.jpg">
</h1>
...
### :scroll: About
```bash
Curso de JavaScript Moderno do básico ao avançado - Atualizado para 2020 (inclui TypeScript - em andamento)

Aprenda Javascript moderno (ES6+) para front-end (com Webpack, babel, React, React Hooks e Redux) e back-end (com Node, Express, MySQL e MongoDB) e se torne um(a) desenvolvedor(a) full stack. Este curso também incluir TypeScript.
...
Uma novidade neste curso é o TypeScript, o aluno não precisará comprar outro curso para aprender essa linguagem que está tão em alta no momento (a seção de TypeScript está em andamento).
...
- TypeScript - Você não precisa comprar outro curso para aprender TypeScript (em andamento)
```
---